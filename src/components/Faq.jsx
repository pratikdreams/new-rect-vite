       ...
       <section className="sec6">
        ...
        <div className="sec6-div2" data-aos="fade-right">
          ...
          <div className="section6-sub">
            <h3 className="section5-h3">Can I modify or customize the templates and components to fit my specific needs?</h3>
           
          </div>
          <div className="section6-sub">
            <h3 className="section5-h3">Can I Use templates and components for client project?</h3>
          
          </div>
          <div className="section6-sub">
            <h3 className="section5-h3">Do you offer documentation to help me get started with using these products?</h3>
