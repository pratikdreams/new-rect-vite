...
export default function Cta() {
  return (
    ...
    <section className="cta">
      ...
      <h1>Create Beautiful Website with Our Templates and UI Components</h1>
      <p>Create a stunning website that stands out with our headless CMS themes, React, Next.js templates, and UI components. Get access and start building!</p>
